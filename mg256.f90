...
subroutine mg256(u,rhs,defpot,ubig,dx,nu,iopt)
implicit none
integer iopt,nu
real u(256,256,256),rhs(256,256,256),defpot(256,256,256),ubig(nu,256,256,256),dx
...
call relax(u,rhshalf,rhs,defpot,ubig,r1,dx,256,256,256,nu,nrelax,irelaxopt) 

! goto 59
call restrict(defhalf,defpot,256,256,256)
call restrictu(usmall,ubig,256,256,256,nu)
call szero(uhalf,N2,N2,N2)

call mg128(uhalf,rhshalf,defhalf,usmall,dx*2,1,iopt)
      
call inject(u,uhalf,256,256,256)
59    continue
irelaxopt=isolver*8+2
call relax(u,rhshalf,rhs,defpot,ubig,relaxerr,dx,256,256,256,nu,nrelax,irelaxopt) 
if (256 .eq. NG) then
   write(*,*) 'relaxerr=',relaxerr
endif
if (256 .ne. NG .and. relaxerr .gt. r1 ) then
  write(*,73) 256,r1,relaxerr
73      format(' mg: relaxation diverged, level=',i3,' r1,2=',2e12.4)
! prolong resets u: forget about the current level relaxation!
!  write(*,*) 'call prolong 256'
!  call prolong(u,uhalf,256,256,256)
  call szero(u,256,256,256)
else
  call zerosum(u,256,256,256)
endif
return
endsubroutine mg256
