...
subroutine mg128(u,rhs,defpot,ubig,dx,nu,iopt)
implicit none
integer iopt,nu
real u(128,128,128),rhs(128,128,128),defpot(128,128,128),ubig(nu,128,128,128),dx
...
call relax(u,rhshalf,rhs,defpot,ubig,r1,dx,128,128,128,nu,nrelax,irelaxopt) 

! goto 59
call restrict(defhalf,defpot,128,128,128)
call restrictu(usmall,ubig,128,128,128,nu)
call szero(uhalf,N2,N2,N2)

call mg64(uhalf,rhshalf,defhalf,usmall,dx*2,1,iopt)
      
call inject(u,uhalf,128,128,128)
59    continue
irelaxopt=isolver*8+2
call relax(u,rhshalf,rhs,defpot,ubig,relaxerr,dx,128,128,128,nu,nrelax,irelaxopt) 
if (128 .eq. NG) then
   write(*,*) 'relaxerr=',relaxerr
endif
if (128 .ne. NG .and. relaxerr .gt. r1 ) then
  write(*,73) 128,r1,relaxerr
73      format(' mg: relaxation diverged, level=',i3,' r1,2=',2e12.4)
! prolong resets u: forget about the current level relaxation!
!  write(*,*) 'call prolong 128'
!  call prolong(u,uhalf,128,128,128)
  call szero(u,128,128,128)
else
  call zerosum(u,128,128,128)
endif
return
endsubroutine mg128
