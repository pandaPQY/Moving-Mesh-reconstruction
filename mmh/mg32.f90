...
subroutine mg32(u,rhs,defpot,ubig,dx,nu,iopt)
implicit none
integer iopt,nu
real u(32,32,32),rhs(32,32,32),defpot(32,32,32),ubig(nu,32,32,32),dx
...
call relax(u,rhshalf,rhs,defpot,ubig,r1,dx,32,32,32,nu,nrelax,irelaxopt) 

! goto 59
call restrict(defhalf,defpot,32,32,32)
call restrictu(usmall,ubig,32,32,32,nu)
call szero(uhalf,N2,N2,N2)

call mg16(uhalf,rhshalf,defhalf,usmall,dx*2,1,iopt)
      
call inject(u,uhalf,32,32,32)
59    continue
irelaxopt=isolver*8+2
call relax(u,rhshalf,rhs,defpot,ubig,relaxerr,dx,32,32,32,nu,nrelax,irelaxopt) 
if (32 .eq. NG) then
   write(*,*) 'relaxerr=',relaxerr
endif
if (32 .ne. NG .and. relaxerr .gt. r1 ) then
  write(*,73) 32,r1,relaxerr
73      format(' mg: relaxation diverged, level=',i3,' r1,2=',2e12.4)
! prolong resets u: forget about the current level relaxation!
!  write(*,*) 'call prolong 32'
!  call prolong(u,uhalf,32,32,32)
  call szero(u,32,32,32)
else
  call zerosum(u,32,32,32)
endif
return
endsubroutine mg32
