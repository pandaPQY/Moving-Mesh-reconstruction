...
subroutine mg512(u,rhs,defpot,ubig,dx,nu,iopt)
implicit none
integer iopt,nu
real u(512,512,512),rhs(512,512,512),defpot(512,512,512),ubig(nu,512,512,512),dx
...
call relax(u,rhshalf,rhs,defpot,ubig,r1,dx,512,512,512,nu,nrelax,irelaxopt) 

! goto 59
call restrict(defhalf,defpot,512,512,512)
call restrictu(usmall,ubig,512,512,512,nu)
call szero(uhalf,N2,N2,N2)

call mg256(uhalf,rhshalf,defhalf,usmall,dx*2,1,iopt)
      
call inject(u,uhalf,512,512,512)
59    continue
irelaxopt=isolver*8+2
call relax(u,rhshalf,rhs,defpot,ubig,relaxerr,dx,512,512,512,nu,nrelax,irelaxopt) 
if (512 .eq. NG) then
   write(*,*) 'relaxerr=',relaxerr
endif
if (512 .ne. NG .and. relaxerr .gt. r1 ) then
  write(*,73) 512,r1,relaxerr
73      format(' mg: relaxation diverged, level=',i3,' r1,2=',2e12.4)
! prolong resets u: forget about the current level relaxation!
!  write(*,*) 'call prolong 512'
!  call prolong(u,uhalf,512,512,512)
  call szero(u,512,512,512)
else
  call zerosum(u,512,512,512)
endif
return
endsubroutine mg512
